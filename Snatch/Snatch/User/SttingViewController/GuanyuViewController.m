...
@interface GuanyuViewController ()<UIWebViewDelegate,UIScrollViewDelegate>
...
//http://www.duonisuoai.com/news/more/id/13
- (void)viewDidLoad {
    [super viewDidLoad];
...
-(void)addWebViewUI{
    ...
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%@/news/more/id/13",URL_BASE]];
