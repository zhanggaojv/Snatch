...
- (NSMutableArray *)questionData {
    if (!_questionData) {
        NSArray *questions = @[@"1.怎样参加夺你所爱？",@"2.夺你所爱怎么计算幸运号码的？",@"3.幸运号码的结果可信吗？",@"4.怎样查看是否成为幸运用户？如何领取幸运商品？",@"5.商品是正品吗？如何保证？",@"6.收到的商品可以退换货吗？",@"7.什么是夺宝币？",@"8.所有活动及商品均与苹果公司无关。"];
...
- (NSMutableArray *)answerData {
    ...
    if (!_answerData) {
        NSArray *answers = @[@[@"使用手机号，QQ，微信登录，就可以参加1元夺宝了"],@[@"商品最后一个号码分配完毕后，将公示分配时间点前本站全部商品的最后50个参与时间"],@[@"由于使用了“老时时彩”揭晓结果作为参数，因此幸运号码肯定是未知的，确保绝对公正公平。"],@[@"个人中心有您的夺宝记录，点击对应的记录，即可知道该期夺宝的获得者。"],@[@"夺你所爱所有商品均从正规渠道采购，100%正品。"],@[@"非质量问题，不在三包范围内，不给予退换货。"],@[@"夺宝币是夺宝奇兵的代币，1个夺宝币可以直接购买1个夺宝号码。"],@[@"通过本产品所从事的任何活动及其获得的任何奖励均与苹果公司无关。"]];
