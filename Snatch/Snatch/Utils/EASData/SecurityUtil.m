...
#define Iv          @"hjdh773JDHGjdh22" //偏移量,可自行修改
#define KEY         @"r0uScmDuH5FLO37A" //key，可自行修改

//#define KEYAES @"r0uScmDuH5FLO37A"
//#define KEYIV  @"hjdh773JDHGjdh22"
...
+(NSString*)dataAESdata:(NSData*)data
