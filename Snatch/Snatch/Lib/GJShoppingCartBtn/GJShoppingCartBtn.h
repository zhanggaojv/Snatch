...
@protocol GJShoppingCartBtnDelegate <NSObject>

@optional
- (void)GJShoppingCartBtn:(UIView *)numberButton number:(NSString *)number;
@end



@interface GJShoppingCartBtn : UIView

/** 加减按钮的回调*/
@property (nonatomic, copy) void(^numberBlock)(NSString *number);
/** 代理*/
@property (nonatomic, weak) id<GJShoppingCartBtnDelegate> delegate;
