...
@interface BDetailsViewController ()<UIWebViewDelegate,UIScrollViewDelegate>
...
@implementation BDetailsViewController
...
-(void)addWebViewUI{
    ...
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%@%@",URL_BASE,self.detailsUrl]];
